...
for ($j = 0; $j < $fileCount; $j++) {
    ...
    foreach ($codes[$j] as $line) {
        $pdf->Cell(10, 10, $lineno, 1, 0, 'L', false);
        $pdf->Cell(210, 10, $line, 1, 0, 'L', false);
        $pdf->Cell(10, 10, $WVS_COL[$j][$lineno], 1, 0, 'L', false);
        $pdf->Cell(10, 10, $NPDTV_COL[$j][$lineno], 1, 0, 'L', false);
        $pdf->Cell(10, 10, $NPCTV_COL[$j][$lineno], 1, 0, 'L', false);
        $pdf->Cell(10, 10, $CV_COL[$j][$lineno], 1, 1, 'L', false);
