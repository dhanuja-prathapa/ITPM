...
for ($j = 0; $j < $fileCount; $j++) {
    ...
    $pdf->AddPage('L', 'A4');
    $z = $j + 1;
    $title = "File " . $fileNames[$j] . " Complexity Due To All Factors";
    ...
    foreach ($codes[$j] as $line) {
        ...
        $pdf->Cell(13, 10,$tcps[$j][$lineno], 1, 0, 'L', false);
        $pdf->Ln();
        $lineno++;
    }
    ...
    $pdf->Cell(15, 10, "END", 1, 0, 'L', false);
    ...
    $pdf->Cell(13, 10,$finalTcps, 1, 0, 'L', false);
