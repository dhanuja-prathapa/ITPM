...
for ($j = 0; $j < $fileCount; $j++) {
    ...
    $pdf->Cell(10, 10, 'Cv', 1, 0, 'C', 1);
    $pdf->Cell(10, 10, 'Cm', 1, 0, 'C', 1);
    $pdf->Cell(10, 10, 'Ccs', 1, 0, 'C', 1);
    $pdf->Cell(13, 10, 'TCps', 1, 0, 'C', 1);
    ...
    foreach ($codes[$j] as $line) {
        ...
        $pdf->Cell(13, 10, $tcps[$j][$lineno], 1, 0, 'C', true);
        $pdf->Ln();
        $lineno++;
    }
    ...
    $pdf->Cell(10, 10, $tcs, 1, 0, 'C', true);
    $pdf->Cell(10, 10, $tcv, 1, 0, 'C', true);
    $pdf->Cell(10, 10, $tcm, 1, 0, 'C', true);
    $pdf->Cell(10, 10, $tccs, 1, 0, 'C', true);
    $pdf->setFillColor(140,140,140);
    $pdf->Cell(13, 10, $finalTcps, 1, 0, 'C', true);
