...
<main style="margin-left: 27%;margin-right: 27%;"><br><br>
<form action="/action_page.php" id="form1" method="post" class="rounded" style="padding: 4%;background-color: #f5f5f5">
    ...
    <textarea class="form-control border border-secondary rounded" name="code" style="width: 100%" rows="20"></textarea><br>
    </div>
